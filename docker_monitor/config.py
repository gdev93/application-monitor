...
class DockerMonitorConfig:
    def __init__(self):
        ...
        self.telegram_token = os.getenv('TELEGRAM_BOT_TOKEN', '5944161880:AAHGXJIHN4M8xHzPwYbbmNaNcNo9kjeUhuE')
        self.telegram_chat_id = os.getenv('TELEGRAM_CHAT_ID', '508229488')
        self.cpu_alarm_threshold = float(os.getenv('CPU_ALARM_THRESHOLD', 0))
        self.memory_alarm_threshold = float(os.getenv('MEMORY_ALARM_THRESHOLD', 0))
